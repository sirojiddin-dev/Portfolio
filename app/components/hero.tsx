...
export default function Hero() {
    return (
        <section className="h-[100vh] relative bg-black">
            ...
            />
            <Header />
            <div className="w-[850px] mx-auto mt-54 text-center">
                <div>
                ...
                <div className="grid grid-cols-[2fr_3fr_2fr]">
                    <div className="hover:bg-blue-400/30 border-dashed border-[2px] border-gray-500 inline-block border-t-0 border-r-0"></div>
                    ...
                    <div className="hover:bg-blue-400/30 border-dashed border-[2px] border-gray-500 inline-block border-t-0 border-l-0"></div>
                </div>
